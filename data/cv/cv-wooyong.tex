...
\item Identification and estimation of dynamic random coefficient models.
\end{enumerate}

\subsection*{Work in Progress}

\begin{itemize}
\item Separating measurement error from multivariate data.
\item Binary choice models with heterogeneous state dependence and partial effects.
\end{itemize}
...
\begin{itemize}
\item PhD level topics course in econometrics. 2021.
\end{itemize}
