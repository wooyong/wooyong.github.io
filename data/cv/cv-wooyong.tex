...
\item
  ...
  \textit{Review of Economic Studies}, Accepted.
\item 
  Lee, W. (2025). 
...
\item Difference-in-differences with dynamic treatment choices.
\end{enumerate}
...
\begin{itemize}
  ...
  \textit{Journal of Accounting Literature}.
\end{itemize}
\end{itemize}
%\section*{Editorial Service}
%
...
\begin{itemize}
\item Billy Norris (2024, co-advisor with Mario Fiorini)
\end{itemize}
