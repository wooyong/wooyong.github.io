...
\begin{itemize}
  ...
  \item M.Sc. Statistics, University of British Columbia, Vancouver, Canada, 2014
    ...
    \item Committee: Nancy Heckman, Priscilla Greenwood.
    \end{itemize}
...
\begin{enumerate}
\item Identifying fixed-effects models with heterogeneous coefficients. 
  \textit{Seoul Journal of Economics} (2025), 38(1), 69--84.

\item 
  Pre-averaged kernel estimators for the drift function of a diffusion process in the presence of microstructure noise. 
  \textit{Statistical Inference for Stochastic Processes} (2016), 20, 237--252.
  (with Priscilla Greenwood, Nancy Heckman and Wolfgang Wefelmeyer)
