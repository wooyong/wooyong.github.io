...
\begin{itemize}
\item Global optimization algorithm for interactive fixed effect models.
\item Identification and estimation of binary choice models with heterogeneous state dependence and partial effects.
\end{itemize}
