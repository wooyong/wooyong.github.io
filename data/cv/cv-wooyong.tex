...
\item 
  Lee, W., Greenwood, P. E., Heckman, N., and Wefelmeyer, W. (2017). 
  ...
  %(with Priscilla Greenwood, Nancy Heckman and Wolfgang Wefelmeyer, Dissertation for MS in Statistics).
...
\item Identification and estimation of dynamic random coefficient models (minor revision requested at \emph{Review of Economic Studies}).
  %(invited for revision at \emph{Review of Economic Studies}, one of the top-5 journals in the field of economics).
\item A simple approach to staggered difference-in-differences in the presence of spillovers (with Mario Fiorini and Gregor Pfeifer) (revision requested at \emph{Journal of Applied Econometrics}).
  %(with Mario Fiorini at UTS and Gregor Pfeifer at U of Sydney; submitted to a journal).
...
\subsection*{Undergraduate Honours Students}
